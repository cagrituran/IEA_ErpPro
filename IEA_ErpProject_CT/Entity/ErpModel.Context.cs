...
namespace IEA_ErpProject_CT.Entity
{
    ...
    public partial class Erp102EvEntities : DbContext
    {
        public Erp102EvEntities()
            : base("name=Erp102EvEntities")
        {
        }
        ...
        public virtual DbSet<tblHastanetip> tblHastanetip { get; set; }
